...
SIDEBAR_LINK_ORDER = (
	...
	("Legal Tasks", "Legal Task", "DocType"),
	("Comunicações", "Case Communication", "DocType"),
	# Gestão de Casos
	("Serviços", "Legal Case", "DocType"),
	("Clients", "Client", "DocType"),
	("Time Entry", "Time Entry", "DocType"),
	("Service Record", "Service Record", "DocType"),
	("Custas Processuais", "Court Cost", "DocType"),
	# Financeiro
	("Legal Payments", "Legal Payment", "DocType"),
	...
	("Honorários por Client", "honorarios_por_cliente", "Report"),
	("Carteira Ativa", "carteira_ativa", "Report"),
	# Cadastros
	("Jurisdiction", "Jurisdiction", "DocType"),
	("Court Branch", "Court Branch", "DocType"),
	("Court", "Court", "DocType"),
	("Case Phase", "Case Phase", "DocType"),
