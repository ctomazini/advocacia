...
DESCRIPTIONS: dict[str, dict[str, str]] = {
	...
	"Legal Payment": {
		...
		"origin_type": "Honorários (Parcela) ou Atos Advocatícios.",
		...
		"installment_number": "Número sequencial da parcela no acordo.",
		"description": "Descrição exibida na parcela e nos relatórios.",
		"installment_origin_id": "Identificador interno para sincronização com parcelas do acordo.",
	...
	"Fee Agreement": {
		...
		"fee_mode": "Honorários Diretos ou Repasse de Sucumbência.",
		"status": "Vigente, Quitado ou Cancelado.",
		"total_agreement_value": "Valor total acordado entre as partes.",
		"lawyer_percentage": "Percentual da advogada sobre o total (modo repasse).",
	...
	"Service Record": {
		...
		"opening_date": "Data de abertura do registro de atos.",
		"acts": "Atos advocatícios acumulados para cobrança.",
		"pending_total": "Soma dos atos pendentes. Calculado automaticamente.",
		"billed_total": "Soma dos atos já cobrados. Calculado automaticamente.",
		"grand_total": "Total geral dos atos. Calculado automaticamente.",
		"billing_due_date": "Vencimento sugerido ao gerar cobrança dos atos pendentes.",
		"last_payment": "Último pagamento de atos vinculado a este registro.",
		"remarks": "Observações sobre o registro de atos.",
		"title": "Título automático no formato ID — descritor.",
	},
	"Legal Act Item": {
		"act_date": "Data do ato praticado.",
		"type": "Tipo do ato: Inicial, Contestação, Audiência, etc.",
		"description": "Descrição do ato praticado.",
		"amount": "Valor a cobrar por este ato.",
