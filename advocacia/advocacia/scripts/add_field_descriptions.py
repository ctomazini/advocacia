...
DESCRIPTIONS: dict[str, dict[str, str]] = {
	"Servico": {
		"cliente": "Cliente titular deste serviço ou processo.",
		...
		"fase_processual": "Fase atual do processo conforme cadastro rígido de Fases Processuais.",
		...
		"vara": "Vara judicial vinculada (cadastro rígido).",
		"tribunal": "Tribunal competente (cadastro rígido).",
		"comarca": "Comarca onde o processo tramita (cadastro rígido).",
	...
	"Cliente": {
		...
		"contatos": "Telefones e e-mails de contato do cliente.",
		"enderecos": "Endereços do cliente. Marque um como principal para documentos.",
	...
	"Pagamento": {
		...
		"acordo": "Acordo de honorários que originou este pagamento (parcelas).",
		"registro_atos": "Registro de atos vinculado (cobrança de atos).",
		"servico": "Serviço ou processo relacionado.",
		"cliente": "Preenchido automaticamente a partir do serviço ou acordo.",
	...
	"Acordo de Honorarios Processuais": {
		"servico": "Serviço ou processo vinculado ao acordo.",
		"cliente": "Preenchido automaticamente a partir do serviço.",
		...
		"tipo_de_cobrança": "Forma de cálculo: valor fixo, percentual ou misto.",
		"percentual_cliente": "Percentual do cliente sobre o total.",
		"valor_cliente": "Parcela destinada ao cliente (repasse).",
		"tipo_de_cálculo": "Forma de cálculo da sucumbência: percentual ou valor fixo.",
		"percentual_sucumbência": "Percentual sobre a sucumbência.",
		"honorários_de_sucumbência": "Valor de honorários de sucumbência.",
		"status_da_sucumbência": "Situação da sucumbência: pendente, recebida, etc.",
		"número_de_parcelas": "Quantidade de parcelas planejadas.",
		"data_primeira_parcela": "Vencimento da primeira parcela.",
		"valor_da_parcela": "Valor médio por parcela (referência).",
		"parcelas": "Parcelas do acordo. Ao salvar, o sistema gera ou atualiza os pagamentos.",
		...
		"observações": "Observações contratuais e anotações internas.",
	...
	"Parcela de Honorarios": {
		...
		"valor_sucumbência": "Parte referente à sucumbência.",
		"valor_cliente": "Parte repassada ao cliente.",
		"descrição": "Descrição exibida na parcela.",
		"parcela_origem_id": "Identificador interno para sincronização. Gerado automaticamente.",
		"pagamento": "Pagamento vinculado gerado pela sincronização.",
	...
	"Audiencia": {
		"servico": "Serviço ou processo vinculado à audiência.",
		"cliente": "Preenchido automaticamente a partir do serviço.",
		...
		"local_vara": "Vara ou local da audiência (cadastro rígido).",
	...
	"Controle de Prazos": {
		"servico": "Serviço ou processo vinculado ao prazo.",
		"cliente": "Preenchido automaticamente a partir do serviço.",
	...
	"Tarefa": {
		"servico": "Serviço relacionado (opcional).",
		"cliente": "Preenchido automaticamente a partir do serviço.",
	...
	"Comunicacao": {
		"servico": "Serviço relacionado à comunicação (opcional).",
		"cliente": "Cliente envolvido na comunicação.",
		...
		"tarefa": "Tarefa gerada a partir desta comunicação.",
		"title": "Título automático no formato ID — descritor.",
	},
	"Registro de Atos": {
		"servico": "Serviço ou processo vinculado aos atos.",
		"cliente": "Preenchido automaticamente a partir do serviço.",
		"status": "Em aberto, Parcialmente cobrado ou Cobrado.",
		"data_abertura": "Data de abertura do registro de atos.",
		"atos": "Atos advocatícios acumulados para cobrança.",
		...
		"ultimo_pagamento": "Último pagamento de atos vinculado a este registro.",
	...
	"Ato Advocaticio": {
		...
		"descrição": "Descrição do ato praticado.",
		"valor": "Valor a cobrar por este ato.",
		"status": "Pendente ou Cobrado.",
		"pagamento": "Pagamento vinculado quando o ato foi faturado.",
	},
	"Registro de Horas": {
		"servico": "Serviço onde a atividade foi realizada.",
		"cliente": "Preenchido automaticamente a partir do serviço.",
	...
	"Custa Processual": {
		"servico": "Serviço ou processo vinculado à custa.",
	...
	"Comarca": {
		"comarca_name": "Nome único da comarca. Usado como identificador do registro.",
		"uf": "Unidade federativa (UF) da comarca.",
		"city": "Cidade sede da comarca.",
	},
	"Vara": {
		"vara_name": "Nome único da vara. Usado como identificador do registro.",
		"comarca": "Comarca à qual esta vara pertence.",
		"court_type": "Tipo: Cível, Criminal, Família, Trabalho, Federal ou Juizado Especial.",
	},
	"Tribunal": {
		"tribunal_name": "Nome único do tribunal.",
		"abbreviation": "Sigla oficial (ex.: TJRS, TRT4).",
		"jurisdiction": "Esfera: Estadual, Federal, Trabalho, Superior ou Militar.",
	},
	"Fase Processual": {
		"phase_name": "Nome da fase (ex.: Conhecimento, Execução).",
