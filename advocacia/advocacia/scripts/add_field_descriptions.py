...
DESCRIPTIONS: dict[str, dict[str, str]] = {
	"Legal Case": {
		...
		"court_branch_link": "Vara judicial vinculada (cadastro rígido).",
		"court": "Tribunal competente (cadastro rígido).",
		"jurisdiction": "Comarca onde o processo tramita (cadastro rígido).",
	...
	"Legal Payment": {
		...
		"origin_type": "Honorários (Parcela) ou cobrança individual.",
		"fee_agreement": "Cobrança de honorários que originou este recebimento (parcelas).",
		"service_record": "Cobrança Individual vinculada.",
		"legal_case": "Processo ou consultoria relacionado.",
		"client": "Preenchido automaticamente a partir do serviço ou honorários.",
		"installment_number": "Número sequencial da parcela na cobrança de honorários.",
	...
	"Fee Agreement": {
		"legal_case": "Processo ou consultoria vinculado à cobrança de honorários.",
	...
	"Hearing": {
		...
		"court_branch": "Vara ou local da audiência (cadastro rígido).",
	...
	"Case Communication": {
		...
		"legal_task": "Tarefa gerada a partir desta comunicação.",
		"title": "Título automático no formato ID — descritor.",
	},
	"Service Record": {
		...
		"opening_date": "Data de abertura da cobrança individual.",
		...
		"remarks": "Observações sobre a cobrança individual.",
		"title": "Título automático no formato ID — descritor.",
	},
	"Legal Act Item": {
	...
	"Court Branch": {
		...
		"jurisdiction": "Comarca à qual esta vara pertence.",
